...
$query = "SELECT uid, username, precio FROM usuarios natural join tickets_comprados natural join datos_viaje WHERE to_date(fechacompra,'YYYYMMDD') >= $inicio and to_date(fechacompra,'YYYYMMDD') <= $termino;";
