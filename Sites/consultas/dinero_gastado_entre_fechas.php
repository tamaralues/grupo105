...
$query = "SELECT uid, username, precio FROM usuarios natural join tickets_comprados natural join datos_viaje WHERE fechacompra::date >= $inicio and fechacompra::date <= $termino;";
