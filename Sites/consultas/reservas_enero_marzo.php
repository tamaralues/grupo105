...
<meta name="theme-color" content="#563d7c">
  ...
  <body>
    ...
    $query = "SELECT uid, username, fechainicio, fechatermino, nombrehotel FROM usuarios natural join reservas natural join hoteles 
        WHERE fechainicio>='2020-01-01' and fechatermino<='2020-03-31';";
        ...
        <table class="table table-striped table-bordered">
          <thead class="thread-dark">
            <tr>
              ...
              <th>username</th>
              <th>fecha inicial de la reserva</th>
